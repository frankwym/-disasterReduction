...
$(function() {
	...
	require(
			...
			function(Map, ArcGISTiledMapServiceLayer,Scalebar, GraphicsLayer,Print,TemplatePicker,Navigation,Draw,geometryEngine,DrawEx,DrawExt,Graphic) {
				...
				baseMapServiceLayer = new ArcGISTiledMapServiceLayer(
...
function buildInterfaceOfSelectMap() {
	...
	// judge whether the parameters of SelectData are ok
	if (CutomizeMapRecords.dataName == ""
			|| CutomizeMapRecords.dataType == ""
			|| CutomizeMapRecords.dataNodeId == ""
			|| (CutomizeMapRecords.classificationIndex == "" && CutomizeMapRecords.statisticalIndex == "")) {
		$("#pre-step").click();
		alert("请先选择制图数据");
		return;
	}
	$("#data-content").empty();
	$("#data-content").append("<div id='mapPanel1' class=\"panel\"></div>");
	$("#mapPanel1")
			.append(
	...
	$("#mapPanel1HeadTitle")
			.children("h4")
			.append(
					'<button class="map-div-title"  data-toggle="collapse" data-parent="#accordion" href="#mapPanel1Collapse" aria-expanded="true" aria-controls="mapPanel1Collapse">地理底图</button>');
	$("#mapPanel1")
			.append(
					'<div id="mapPanel1Collapse" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="mapPanel1Head"></div>');
	$("#mapPanel1Collapse").append('<div class="panel-body"></div>');

	var mapThumbnailData = [
	    					[
	    	            					"images/mapThumbnail/reliefShading_danya.JPG",
	    	            					"地貌晕眩淡雅版",
	    	            					"http://172.16.20.132/tjch_sqjc_wmts02/rest/services/DEM/reliefShading_danya_cover_201703151645/MapServer" ],
	    					[
	    	            					"images/mapThumbnail/reliefShading_mingyan.JPG",
	    	            					"地貌晕眩明艳版",
	    	            					"http://172.16.20.132/tjch_sqjc_wmts02/rest/services/DEM/reliefShading_mingyan_cover/MapServer" ],
	    	            			[
	    	            					"images/mapThumbnail/dom.JPG",
	    	            					"影像图",
	    	            					"http://172.16.20.132/tjch_sqjc_wmts02/rest/services/DEM/dom_cover/MapServer" ],
	    	            			[
	    	            					"images/mapThumbnail/slope.JPG",
	    	            					"坡度图",
	    	            					"http://172.16.20.132/tjch_sqjc_wmts02/rest/services/DEM/slope_cover/MapServer" ],
	    	            			[
	    	            					"images/mapThumbnail/dsjdb.png",
	    	            					"大数据Dark版",
	    	            					"http://172.16.20.132/tjch_sqjc_wmts02/rest/services/wuda_vector/dsjdb/MapServer"  ],
	    	            			[
	    	            					"images/mapThumbnail/dsjlb.png",
	    	            					"大数据Light版",
	    	            					"http://172.16.20.132/tjch_sqjc_wmts02/rest/services/wuda_vector/dsjlb/MapServer"  ],
	    	            			[
	    	            					"images/mapThumbnail/fzzqb.png",
	    	            					"复杂政区版",
	    	            					"http://172.16.20.132/tjch_sqjc_wmts02/rest/services/wuda_vector/fzzqb/MapServer"  ],
	    	            			[
	    	            					"images/mapThumbnail/jdzqb.png",
	    	            					"简单政区版",
	    	            					"http://172.16.20.132/tjch_sqjc_wmts02/rest/services/wuda_vector/jdzqb/MapServer"  ],
	    	            			[
	    	            					"images/mapThumbnail/lsdb.png",
	    	            					"冷色调版",
	    	            					"http://172.16.20.132/tjch_sqjc_wmts02/rest/services/wuda_vector/lsdb/MapServer" ],
	    	            			[
	    	            					"images/mapThumbnail/mlfgb.png",
	    	            					"明亮风格版",
	    	            					"http://172.16.20.132/tjch_sqjc_wmts02/rest/services/wuda_vector/mlfgb/MapServer" ],
	    	            			[
	    	            					"images/mapThumbnail/nsdb.png",
	    	            					"暖色调版",
	    	            					"http://172.16.20.132/tjch_sqjc_wmts02/rest/services/wuda_vector/nsdb/MapServer" ],
	    	            			[
	    	            					"images/mapThumbnail/qxfgb.png",
	    	            					"清新风格版",
	    	            					"http://172.16.20.132/tjch_sqjc_wmts02/rest/services/wuda_vector/qxfgb/MapServer" ]
